...
interface BtnDeleteDialogProps {
  rowSelection: {};
  deleteManySubCategory: UseMutationResult<any, Error, string[], unknown>;
  ...
  return (
    <div className="mb-2">
      <AlertDialog>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Are you deleted sub categories?</AlertDialogTitle>
            <AlertDialogDescription>
          ...
          <AlertDialogFooter>
            ...
            <Button
              ...
              onClick={() => {
                ...
                deleteManySubCategory.mutate(ids);
                setRowSelection({});
              }}
            >
              Continue
