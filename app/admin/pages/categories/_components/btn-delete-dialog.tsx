...
interface BtnDeleteDialogProps {
  rowSelection: {};
  deleteManyCategory: UseMutationResult<any, Error, string[], unknown>;
  ...
  return (
    <div className="mb-2">
      <AlertDialog>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Are you deleted categories?</AlertDialogTitle>
            <AlertDialogDescription>
