...
type SearchByType = "title" | "slug" | "category" | "sub_category" | "all";

type DataTableProps = {
  columns: ColumnDef<ProductListType>[];
  ...
  deleteManyProducts: ReturnType<typeof useProducts>["useDeleteManyProducts"];
...
export function DataTableProducts({
  ...
  const [columnVisibility, setColumnVisibility] =
    React.useState<VisibilityState>(() =>
      getColumnsVisibility("productsColumns")
    );

  React.useEffect(() => {
    setColumnsVisibility("productsColumns", columnVisibility);
  }, [columnVisibility]);
  ...
  return (
    <div className="w-full">
      <div className="flex items-center py-4 gap-x-2 justify-between">
        <Hint asChild label="Add product" side="right">
          <Link
      ...
      <ButtonDeleteDialog
        ...
        deleteManyProducts={deleteManyProducts}
