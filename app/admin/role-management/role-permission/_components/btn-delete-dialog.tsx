...
interface BtnDeleteDialogProps {
  rowSelection: {};
  deleteManyRolePermission: UseMutationResult<any, Error, string[], unknown>;
  setRowSelection: (value: React.SetStateAction<{}>) => void;
}

const ButtonDeleteDialog = ({
  rowSelection,
  deleteManyRolePermission,
  setRowSelection,
    ...
    <div className="mb-2">
      <AlertDialog>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>
              Are you deleted role permission?
            </AlertDialogTitle>
            <AlertDialogDescription>
          ...
          <AlertDialogFooter>
            ...
            <Button
              ...
              onClick={() => {
                ...
                console.log(ids);
                deleteManyRolePermission.mutate(ids);
                setRowSelection({});
              }}
            >
              Continue
